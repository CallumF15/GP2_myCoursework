		...
		while (SDL_PollEvent(&event)) {
			...
			case SDL_KEYDOWN:
				...
				case SDLK_w:
					...
					break;
				case SDLK_s:
					//c->setMovementType(BACKWARD);
					movetype = BACKWARD;
					c->movement(BACKWARD);
					break;
				case SDLK_a:
					//c->setMovementType(STRAFE_LEFT);
					movetype = STRAFE_LEFT;
					c->movement(STRAFE_LEFT);
					break;
				case SDLK_d:
					//c->setMovementType(STRAFE_RIGHT);
					movetype = STRAFE_RIGHT;
