...
void Mesh::init()
{
	...
	glVertexAttribPointer(3, 3, GL_FLOAT, GL_FALSE, sizeof(Vertex), (void**)(sizeof(vec3) + sizeof(vec3) + sizeof(vec2))); //double check this: Changed 2nd value from 4 to 3 as Struct contains 3 values
